...
public class GUIEquipFragmentBagItem : GUICommonBagItem
{
	private GUIEquipBagScene mBaseScene;

	protected override void InitObjects()
	{
		this.mBaseScene = (this.mOriginal as GUIEquipBagScene);
		this.mBG.height = 106;
	...
	public override void OnClickableBtnClick(GameObject go)
	{
		...
		if (this.mData.CanCreate())
		{
			this.mBaseScene.SendEquipCreateMsg(this.mData);
		}
		else
		{
	...
	{
		GUIEquipInfoPopUp.ShowThis(this.mData, GUIEquipInfoPopUp.EIPT.EIPT_Fragment, -1, false, true);
	}
