...
public class PVEStarsRankItem : CommonRankItemBase
{
	...
	{
		return string.Format("{0}{1}", Singleton<StringManager>.Instance.GetString("BillboardPVEStarsTxt"), this.mRankData.Value);
	}
