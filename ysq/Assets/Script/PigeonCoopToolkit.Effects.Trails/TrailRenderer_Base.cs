...
namespace PigeonCoopToolkit.Effects.Trails
{
	public abstract class TrailRenderer_Base : MonoBehaviour
	{
		...
		protected virtual void LateUpdate()
		{
			...
			foreach (KeyValuePair<Material, List<PCTrail>> current in TrailRenderer_Base._matToTrailList)
			{
		...
		protected virtual void Update()
		{
			...
			{
				if (this._fadingTrails[i] == null || !this._fadingTrails[i].Points.Any((PCTrailPoint a) => a.TimeActive() < this.TrailData.Lifetime))
				{
		...
		public virtual void OnStopEmit()
		{
		}

		public virtual void OnStartEmit()
		{
		}
