...
public class GUIChatMessageLayer : MonoBehaviour
{
	private GUIChatMessageTable mMsgChanelTable;
	...
	{
		this.mMsgChanelTable = base.transform.Find("worldChatPanel/chatContents").gameObject.AddComponent<GUIChatMessageTable>();
	...
	public void RefreshChatTable()
	{
		if (this.mMsgChanelTable != null)
		{
			this.mMsgChanelTable.Refresh();
		}
	}
	...
	{
        return null;
        //GUIChatMessageLayer.<UpdateScrollBar>c__Iterator33 <UpdateScrollBar>c__Iterator = new GUIChatMessageLayer.<UpdateScrollBar>c__Iterator33();
