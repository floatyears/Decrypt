...
public class UISprite : UIBasicSprite
{
	...
	public string spriteName
	{
		...
		set
		{
			...
			if (this.mCachedAtlas == null)
			{
				this.mCachedAtlas = this.mAtlas;
			}
			if (this.mCachedAtlas != null)
			{
				UIAtlas uIAtlas = this.mCachedAtlas;
				this.atlas = this.mCachedAtlas.OnInit(this.mSpriteName);
				this.mCachedAtlas = uIAtlas;
			}
		}
	}
	...
	protected override void OnStart()
	{
		...
		if (this.mCachedAtlas != null)
		{
			this.mAtlas = this.mCachedAtlas.OnInit(this.mSpriteName);
		}
	}
	...
	public UISpriteData GetAtlasSprite()
	{
		...
		if (this.mSprite == null && this.mAtlas != null)
		{
			if (!string.IsNullOrEmpty(this.mSpriteName))
			{
				UISpriteData sprite = this.atlas.GetSprite(this.mSpriteName);
				if (sprite == null)
				{
					return null;
				}
			...
			if (this.mSprite == null && this.mAtlas.spriteList.Count > 0)
			{
				...
				if (this.mSprite == null)
				{
					...
					{
						this.mAtlas.name + " seems to have a null sprite!"
					});
					return null;
				}
				this.mSpriteName = this.mSprite.name;
