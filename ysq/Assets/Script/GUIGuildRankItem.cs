...
public class GUIGuildRankItem : CommonRankItemBase
{
	public GuildRank mGuildRankData;
	...
	{
		return Globals.Instance.Player.GuildSystem.GetGuildRank(this.mGuildRankData);
	}
	...
	{
		return string.Format("{0}{1}", Singleton<StringManager>.Instance.GetString("guild22"), this.mGuildRankData.Value);
	}
	...
	public override void Refresh()
	{
		...
		if (Globals.Instance.Player.GuildSystem.Rank > 0 && Globals.Instance.Player.GuildSystem.GetGuildRank(this.mGuildRankData) == Globals.Instance.Player.GuildSystem.Rank)
		{
