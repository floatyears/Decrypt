...
public class UICenterOnChild : MonoBehaviour
{
	...
	public void Recenter()
	{
		if (this.mScrollView == null)
		{
			...
			{
				this.mScrollView.centerOnChild = this;
				UIScrollView expr_A0 = this.mScrollView;
				expr_A0.onDragFinished = (UIScrollView.OnDragNotification)Delegate.Combine(expr_A0.onDragFinished, new UIScrollView.OnDragNotification(this.OnDragFinished));
			}
			if (this.mScrollView.horizontalScrollBar != null)
			{
				UIProgressBar expr_E2 = this.mScrollView.horizontalScrollBar;
				expr_E2.onDragFinished = (UIProgressBar.OnDragFinished)Delegate.Combine(expr_E2.onDragFinished, new UIProgressBar.OnDragFinished(this.OnDragFinished));
			}
			if (this.mScrollView.verticalScrollBar != null)
			{
				UIProgressBar expr_124 = this.mScrollView.verticalScrollBar;
				expr_124.onDragFinished = (UIProgressBar.OnDragFinished)Delegate.Combine(expr_124.onDragFinished, new UIProgressBar.OnDragFinished(this.OnDragFinished));
			}
		}
