...
public class LevelRankItem : CommonRankItemBase
{
	...
	{
		return string.Format("{0}{1}", Singleton<StringManager>.Instance.GetString("BillboardLevelCharacterTxt"), this.mRankData.Value);
	}
