...
public class TurtleRankItem : CommonRankItemBase
{
	...
	{
		return string.Format("{0}{1}", Singleton<StringManager>.Instance.GetString("BillboardTurtleNum"), this.mRankData.Value);
	}
