...
namespace Proto
{
	[ProtoContract(Name = "MS2C_PveStart")]
	[Serializable]
	public class MS2C_PveStart : IExtensible
	{
		private int _Result;
		...
		[ProtoMember(3, IsRequired = false, Name = "Key", DataFormat = DataFormat.TwosComplement), DefaultValue(0)]
		public int Key
		{
			get
			{
