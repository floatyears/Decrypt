...
namespace Proto
{
	[ProtoContract(Name = "GuildWarClient")]
	[Serializable]
	public class GuildWarClient : IExtensible
	{
		private EGuildWarId _WarID;

		private GuildWarClientTeam _Red;

		private GuildWarClientTeam _Blue;
		...
		public GuildWarClientTeam Blue
		{
			get
			{
				return this._Blue;
