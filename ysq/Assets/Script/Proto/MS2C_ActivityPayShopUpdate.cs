...
namespace Proto
{
	[ProtoContract(Name = "MS2C_ActivityPayShopUpdate")]
	[Serializable]
	public class MS2C_ActivityPayShopUpdate : IExtensible
	{
		private ActivityPayShopData _Data;
		...
		public ActivityPayShopData Data
		{
			get
			{
				return this._Data;
