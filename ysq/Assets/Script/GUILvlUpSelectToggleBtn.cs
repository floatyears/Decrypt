...
public class GUILvlUpSelectToggleBtn : MonoBehaviour
{
	public delegate void ToggleChangedCallback(bool isCheck);

	public delegate void ToggleClickCallback();

	public GUILvlUpSelectToggleBtn.ToggleChangedCallback ToggleChangedEvent;

	public GUILvlUpSelectToggleBtn.ToggleClickCallback ToggleClickEvent;
	...
	{
		if (this.ToggleClickEvent != null && !this.IsChecked)
		{
